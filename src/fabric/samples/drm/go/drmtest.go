...
func (t *DrmChaincode) Init(stub shim.ChaincodeStubInterface) sc.Response {
	// nothing to do
	return shim.Success(nil)
}

// query the drm info by item's identity
func (t *DrmChaincode) Query(stub shim.ChaincodeStubInterface, args []string)  sc.Response {
	if len(args) != 1 {
...
func (t * DrmChaincode) Publish(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (t * DrmChaincode) Check(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (t * DrmChaincode) Invoke(stub shim.ChaincodeStubInterface) sc.Response {
