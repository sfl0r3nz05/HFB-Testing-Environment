...
func (t *SmallbankChaincode) Init(stub shim.ChaincodeStubInterface) sc.Response {
	// nothing to do
	return shim.Success(nil)
}

func (t *SmallbankChaincode) Invoke(stub shim.ChaincodeStubInterface) sc.Response {
...
func (t *SmallbankChaincode) CreateAccount(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (t *SmallbankChaincode) DepositChecking(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (t *SmallbankChaincode) WriteCheck(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	if len(args) != 2 {	// should be [amount,customer_id]
...
func (t *SmallbankChaincode) TransactSavings(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	if len(args) != 2 {	// should be [amount,customer_id]
...
func (t *SmallbankChaincode) SendPayment(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (t *SmallbankChaincode) Amalgamate(stub shim.ChaincodeStubInterface, args []string) sc.Response {
...
func (t *SmallbankChaincode) Query(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	key := accountKey(args[0])
...
func errormsg(msg string) sc.Response {
	return shim.Error("{\"error\":"+msg+"}")
}

func systemerror(err string) sc.Response {
